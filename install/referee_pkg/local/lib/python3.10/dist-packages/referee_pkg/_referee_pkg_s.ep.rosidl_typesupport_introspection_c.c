...
static PyMethodDef referee_pkg__methods[] = {
  {NULL, NULL, 0, NULL}  /* sentinel */
};

static struct PyModuleDef referee_pkg__module = {
  PyModuleDef_HEAD_INIT,
  "_referee_pkg_support",
  "_referee_pkg_doc",
  -1,  /* -1 means that the module keeps state in global variables */
  referee_pkg__methods,
  NULL,
  NULL,
  NULL,
  NULL,
...
static void * referee_pkg__msg__object__create_ros_message(void)
{
  return referee_pkg__msg__Object__create();
}

static void referee_pkg__msg__object__destroy_ros_message(void * raw_ros_message)
{
  referee_pkg__msg__Object * ros_message = (referee_pkg__msg__Object *)raw_ros_message;
  referee_pkg__msg__Object__destroy(ros_message);
}

ROSIDL_GENERATOR_C_IMPORT
bool referee_pkg__msg__object__convert_from_py(PyObject * _pymsg, void * ros_message);
ROSIDL_GENERATOR_C_IMPORT
PyObject * referee_pkg__msg__object__convert_to_py(void * raw_ros_message);


ROSIDL_GENERATOR_C_IMPORT
const rosidl_message_type_support_t *
ROSIDL_GET_MSG_TYPE_SUPPORT(referee_pkg, msg, Object);
...
_register_msg_type__msg__object(PyObject * pymodule)
{
  ...
  pyobject_create_ros_message = PyCapsule_New(
    (void *)&referee_pkg__msg__object__create_ros_message,
    NULL, NULL);
  ...
  pyobject_destroy_ros_message = PyCapsule_New(
    (void *)&referee_pkg__msg__object__destroy_ros_message,
    NULL, NULL);
  ...
  pyobject_convert_from_py = PyCapsule_New(
    (void *)&referee_pkg__msg__object__convert_from_py,
    NULL, NULL);
  ...
  pyobject_convert_to_py = PyCapsule_New(
    (void *)&referee_pkg__msg__object__convert_to_py,
    NULL, NULL);
  ...
  pyobject_type_support = PyCapsule_New(
    (void *)ROSIDL_GET_MSG_TYPE_SUPPORT(referee_pkg, msg, Object),
    NULL, NULL);
...
static void * referee_pkg__msg__multi_object__create_ros_message(void)
{
  return referee_pkg__msg__MultiObject__create();
}

static void referee_pkg__msg__multi_object__destroy_ros_message(void * raw_ros_message)
{
  referee_pkg__msg__MultiObject * ros_message = (referee_pkg__msg__MultiObject *)raw_ros_message;
  referee_pkg__msg__MultiObject__destroy(ros_message);
}

ROSIDL_GENERATOR_C_IMPORT
bool referee_pkg__msg__multi_object__convert_from_py(PyObject * _pymsg, void * ros_message);
ROSIDL_GENERATOR_C_IMPORT
PyObject * referee_pkg__msg__multi_object__convert_to_py(void * raw_ros_message);


ROSIDL_GENERATOR_C_IMPORT
const rosidl_message_type_support_t *
ROSIDL_GET_MSG_TYPE_SUPPORT(referee_pkg, msg, MultiObject);

int8_t
_register_msg_type__msg__multi_object(PyObject * pymodule)
{
  int8_t err;

  PyObject * pyobject_create_ros_message = NULL;
  pyobject_create_ros_message = PyCapsule_New(
    (void *)&referee_pkg__msg__multi_object__create_ros_message,
    NULL, NULL);
  if (!pyobject_create_ros_message) {
    // previously added objects will be removed when the module is destroyed
    return -1;
  ...
  err = PyModule_AddObject(
    pymodule,
    "create_ros_message_msg__msg__multi_object",
    pyobject_create_ros_message);
  if (err) {
    // the created capsule needs to be decremented
    Py_XDECREF(pyobject_create_ros_message);
  ...
  PyObject * pyobject_destroy_ros_message = NULL;
  pyobject_destroy_ros_message = PyCapsule_New(
    (void *)&referee_pkg__msg__multi_object__destroy_ros_message,
    NULL, NULL);
  if (!pyobject_destroy_ros_message) {
    // previously added objects will be removed when the module is destroyed
    return -1;
  ...
  err = PyModule_AddObject(
    pymodule,
    "destroy_ros_message_msg__msg__multi_object",
    pyobject_destroy_ros_message);
  if (err) {
    // the created capsule needs to be decremented
    Py_XDECREF(pyobject_destroy_ros_message);
  ...
  PyObject * pyobject_convert_from_py = NULL;
  pyobject_convert_from_py = PyCapsule_New(
    (void *)&referee_pkg__msg__multi_object__convert_from_py,
    NULL, NULL);
  if (!pyobject_convert_from_py) {
    // previously added objects will be removed when the module is destroyed
    return -1;
  ...
  err = PyModule_AddObject(
    pymodule,
    "convert_from_py_msg__msg__multi_object",
    pyobject_convert_from_py);
  if (err) {
    // the created capsule needs to be decremented
    Py_XDECREF(pyobject_convert_from_py);
  ...
  PyObject * pyobject_convert_to_py = NULL;
  pyobject_convert_to_py = PyCapsule_New(
    (void *)&referee_pkg__msg__multi_object__convert_to_py,
    NULL, NULL);
  if (!pyobject_convert_to_py) {
    // previously added objects will be removed when the module is destroyed
    return -1;
  ...
  err = PyModule_AddObject(
    pymodule,
    "convert_to_py_msg__msg__multi_object",
    pyobject_convert_to_py);
  if (err) {
    // the created capsule needs to be decremented
    Py_XDECREF(pyobject_convert_to_py);
  ...
  PyObject * pyobject_type_support = NULL;
  pyobject_type_support = PyCapsule_New(
    (void *)ROSIDL_GET_MSG_TYPE_SUPPORT(referee_pkg, msg, MultiObject),
    NULL, NULL);
  if (!pyobject_type_support) {
    // previously added objects will be removed when the module is destroyed
    return -1;
  ...
  err = PyModule_AddObject(
    pymodule,
    "type_support_msg__msg__multi_object",
    pyobject_type_support);
  if (err) {
    // the created capsule needs to be decremented
    Py_XDECREF(pyobject_type_support);
...
static void * referee_pkg__msg__race_stage__create_ros_message(void)
{
  return referee_pkg__msg__RaceStage__create();
}

static void referee_pkg__msg__race_stage__destroy_ros_message(void * raw_ros_message)
{
  referee_pkg__msg__RaceStage * ros_message = (referee_pkg__msg__RaceStage *)raw_ros_message;
  referee_pkg__msg__RaceStage__destroy(ros_message);
}

ROSIDL_GENERATOR_C_IMPORT
bool referee_pkg__msg__race_stage__convert_from_py(PyObject * _pymsg, void * ros_message);
ROSIDL_GENERATOR_C_IMPORT
PyObject * referee_pkg__msg__race_stage__convert_to_py(void * raw_ros_message);


ROSIDL_GENERATOR_C_IMPORT
const rosidl_message_type_support_t *
ROSIDL_GET_MSG_TYPE_SUPPORT(referee_pkg, msg, RaceStage);

int8_t
_register_msg_type__msg__race_stage(PyObject * pymodule)
{
  int8_t err;

  PyObject * pyobject_create_ros_message = NULL;
  pyobject_create_ros_message = PyCapsule_New(
    (void *)&referee_pkg__msg__race_stage__create_ros_message,
    NULL, NULL);
  if (!pyobject_create_ros_message) {
    // previously added objects will be removed when the module is destroyed
    return -1;
  ...
  err = PyModule_AddObject(
    pymodule,
    "create_ros_message_msg__msg__race_stage",
    pyobject_create_ros_message);
  if (err) {
    // the created capsule needs to be decremented
    Py_XDECREF(pyobject_create_ros_message);
  ...
  PyObject * pyobject_destroy_ros_message = NULL;
  pyobject_destroy_ros_message = PyCapsule_New(
    (void *)&referee_pkg__msg__race_stage__destroy_ros_message,
    NULL, NULL);
  if (!pyobject_destroy_ros_message) {
    // previously added objects will be removed when the module is destroyed
    return -1;
  ...
  err = PyModule_AddObject(
    pymodule,
    "destroy_ros_message_msg__msg__race_stage",
    pyobject_destroy_ros_message);
  if (err) {
    // the created capsule needs to be decremented
    Py_XDECREF(pyobject_destroy_ros_message);
  ...
  PyObject * pyobject_convert_from_py = NULL;
  pyobject_convert_from_py = PyCapsule_New(
    (void *)&referee_pkg__msg__race_stage__convert_from_py,
    NULL, NULL);
  if (!pyobject_convert_from_py) {
    // previously added objects will be removed when the module is destroyed
    return -1;
  ...
  err = PyModule_AddObject(
    pymodule,
    "convert_from_py_msg__msg__race_stage",
    pyobject_convert_from_py);
  if (err) {
    // the created capsule needs to be decremented
    Py_XDECREF(pyobject_convert_from_py);
  ...
  PyObject * pyobject_convert_to_py = NULL;
  pyobject_convert_to_py = PyCapsule_New(
    (void *)&referee_pkg__msg__race_stage__convert_to_py,
    NULL, NULL);
  if (!pyobject_convert_to_py) {
    // previously added objects will be removed when the module is destroyed
    return -1;
  ...
  err = PyModule_AddObject(
    pymodule,
    "convert_to_py_msg__msg__race_stage",
    pyobject_convert_to_py);
  if (err) {
    // the created capsule needs to be decremented
    Py_XDECREF(pyobject_convert_to_py);
  ...
  PyObject * pyobject_type_support = NULL;
  pyobject_type_support = PyCapsule_New(
    (void *)ROSIDL_GET_MSG_TYPE_SUPPORT(referee_pkg, msg, RaceStage),
    NULL, NULL);
  if (!pyobject_type_support) {
    // previously added objects will be removed when the module is destroyed
    return -1;
  ...
  err = PyModule_AddObject(
    pymodule,
    "type_support_msg__msg__race_stage",
    pyobject_type_support);
  if (err) {
    // the created capsule needs to be decremented
    Py_XDECREF(pyobject_type_support);
...
PyMODINIT_FUNC
PyInit_referee_pkg_s__rosidl_typesupport_introspection_c(void)
{
  PyObject * pymodule = NULL;
  pymodule = PyModule_Create(&referee_pkg__module);
  if (!pymodule) {
    return NULL;
  }
  int8_t err;
  ...
  err = _register_msg_type__msg__multi_object(pymodule);
  if (err) {
    Py_XDECREF(pymodule);
    return NULL;
  }

  err = _register_msg_type__msg__race_stage(pymodule);
  if (err) {
    Py_XDECREF(pymodule);
    return NULL;
  }
