...
bool referee_pkg__msg__target__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("referee_pkg.msg._target.Target", full_classname_dest, 30) == 0);
  }
  referee_pkg__msg__Target * ros_message = _ros_message;
  {  // target_type
...
PyObject * referee_pkg__msg__target__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("referee_pkg.msg._target");
