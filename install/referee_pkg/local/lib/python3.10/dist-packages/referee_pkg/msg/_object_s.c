...
bool referee_pkg__msg__object__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("referee_pkg.msg._object.Object", full_classname_dest, 30) == 0);
  }
  referee_pkg__msg__Object * ros_message = _ros_message;
  {  // target_type
    ...
    rosidl_runtime_c__String__assign(&ros_message->target_type, PyBytes_AS_STRING(encoded_field));
  ...
  {  // corners
    ...
    geometry_msgs__msg__Point * dest = ros_message->corners.data;
...
PyObject * referee_pkg__msg__object__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("referee_pkg.msg._object");
  ...
  {  // target_type
    ...
    field = PyUnicode_DecodeUTF8(
      ros_message->target_type.data,
      strlen(ros_message->target_type.data),
      "replace");
    if (!field) {
      return NULL;
    }
