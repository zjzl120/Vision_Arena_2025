...
static const _HitArror_Request_type_support_symbol_names_t _HitArror_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, referee_pkg, srv, HitArror_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, referee_pkg, srv, HitArror_Request)),
  }
};
...
{
  return &::referee_pkg::srv::rosidl_typesupport_cpp::HitArror_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, referee_pkg, srv, HitArror_Request)() {
  return get_message_type_support_handle<referee_pkg::srv::HitArror_Request>();
}
...
static const _HitArror_Response_type_support_symbol_names_t _HitArror_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, referee_pkg, srv, HitArror_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, referee_pkg, srv, HitArror_Response)),
  }
};
...
{
  return &::referee_pkg::srv::rosidl_typesupport_cpp::HitArror_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, referee_pkg, srv, HitArror_Response)() {
  return get_message_type_support_handle<referee_pkg::srv::HitArror_Response>();
}
...
static const _HitArror_type_support_symbol_names_t _HitArror_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, referee_pkg, srv, HitArror)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, referee_pkg, srv, HitArror)),
  }
};
...
{
  return &::referee_pkg::srv::rosidl_typesupport_cpp::HitArror_service_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_cpp, referee_pkg, srv, HitArror)() {
  return ::rosidl_typesupport_cpp::get_service_type_support_handle<referee_pkg::srv::HitArror>();
}
