...
static const _MultiObject_type_support_symbol_names_t _MultiObject_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, referee_pkg, msg, MultiObject)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, referee_pkg, msg, MultiObject)),
  }
};
...
{
  return &::referee_pkg::msg::rosidl_typesupport_cpp::MultiObject_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, referee_pkg, msg, MultiObject)() {
  return get_message_type_support_handle<referee_pkg::msg::MultiObject>();
}
