...
bool referee_pkg__srv__hit_arror__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("referee_pkg.srv._hit_arror.HitArror_Request", full_classname_dest, 43) == 0);
  }
  referee_pkg__srv__HitArror_Request * ros_message = _ros_message;
  {  // modelpoint
    PyObject * field = PyObject_GetAttrString(_pymsg, "modelpoint");
    if (!field) {
      return false;
    }
    PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'modelpoint'");
    if (!seq_field) {
      Py_DECREF(field);
      return false;
    }
    ...
    geometry_msgs__msg__Point * dest = ros_message->modelpoint.data;
...
{
  /* NOTE(esteve): Call constructor of HitArror_Request */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("referee_pkg.srv._hit_arror");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "HitArror_Request");
  ...
  {  // modelpoint
    ...
    for (size_t i = 0; i < size; ++i) {
      item = &(ros_message->modelpoint.data[i]);
    ...
    {
      int rc = PyObject_SetAttrString(_pymessage, "modelpoint", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
...
ROSIDL_GENERATOR_C_EXPORT
bool referee_pkg__srv__hit_arror__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("referee_pkg.srv._hit_arror.HitArror_Response", full_classname_dest, 44) == 0);
  }
  referee_pkg__srv__HitArror_Response * ros_message = _ros_message;
  {  // yaw
...
{
  /* NOTE(esteve): Call constructor of HitArror_Response */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("referee_pkg.srv._hit_arror");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "HitArror_Response");
    assert(pymessage_class);
    Py_DECREF(pymessage_module);
    _pymessage = PyObject_CallObject(pymessage_class, NULL);
    Py_DECREF(pymessage_class);
