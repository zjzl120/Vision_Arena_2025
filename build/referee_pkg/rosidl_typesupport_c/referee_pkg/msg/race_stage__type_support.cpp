...
static const _RaceStage_type_support_symbol_names_t _RaceStage_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, referee_pkg, msg, RaceStage)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, referee_pkg, msg, RaceStage)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, referee_pkg, msg, RaceStage)() {
  return &::referee_pkg::msg::rosidl_typesupport_c::RaceStage_message_type_support_handle;
}
