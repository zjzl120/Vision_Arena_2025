...
#include "referee_pkg/msg/detail/object__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = referee_pkg::msg::Object;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const referee_pkg::msg::Object *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<referee_pkg::msg::Object *>(
    untyped_ros_message);
...
{
  return &referee_pkg::msg::typesupport_fastrtps_cpp::_Object__handle;
}
