...
#include "referee_pkg/msg/detail/target__rosidl_typesupport_fastrtps_c.h"
...
using _Target__ros_msg_type = referee_pkg__msg__Target;
...
static uint32_t _Target__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_referee_pkg__msg__Target(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = referee_pkg__msg__Target;
    is_plain =
      (
...
static size_t _Target__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_referee_pkg__msg__Target(
